...
public class CooliGuiDisconnected extends GuiScreen
{
    ...
    public CooliGuiDisconnected(GuiScreen p_i45020_1_, String p_i45020_2_, IChatComponent p_i45020_3_)
    {
    ...
    {
    	mc.getTextureManager().bindTexture(new ResourceLocation(Reference.MOD_ID, "textures/gui/background.jpg"));
