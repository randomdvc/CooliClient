...
public class GuiIngameMenuC extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(12, this.width / 2 + 2, this.height / 4 + 96 + b0, 98, 20, "Jobs"));
        GuiButton guibutton;
    ...
    protected void actionPerformed(GuiButton p_146284_1_)
    {
        switch (p_146284_1_.id)
        {
            ...
            case 7:
                ...
                break;
            case 12:
            	this.mc.displayGuiScreen(new GuiJobs());
                break;
        }
    }
